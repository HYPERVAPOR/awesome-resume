...
{\heiti 北京·海淀·五道口 \quad$|$\quad PuppyAgent \quad$|$\quad 前端开发 / 大模型应用开发 \quad$|$\quad 2025.06-2025.09}
...
{\heiti 其他项目 \quad$|$\quad 简短描述 \quad$|$\quad \uline{\href{https://prodlens.hypervapor.cloud}{点此预览}} \quad$|$\quad \uline{\href{https://github.com/HYPERVAPOR/prodlens}{Github仓库}}
\begin{itemize}[itemsep=0pt,parsep=0pt,topsep=0pt]
    \item {\songti 描述信息1}
    \item {\songti 描述信息2}
\end{itemize}
...
\begin{itemize}[itemsep=0pt,parsep=0pt,topsep=0pt]
    \item {\songti 计算机软件著作权：融合多种增强技术的代码安全大模型软件系统V1.0 登记号：2025SR1201602}
    \item {\songti 参与编写研究生教材《大语言模型系统工程理论与实践》}
\end{itemize}
...
\begin{itemize}[itemsep=0pt,parsep=0pt,topsep=0pt]
    ...
    \item {\songti 正在充分利用AI工作流运营自媒体账号，粉丝量1000+，点赞量1000+，评论量1000+}
